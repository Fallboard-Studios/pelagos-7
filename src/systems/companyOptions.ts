 ...
 * a field the company HAS been edited for reads from its own recorded snapshot instead. See
 * docs/specs/COMPANIES.md §7.1 for why this is a deliberate simplification over literally
 * cloning the first member's values into lastEditedOptions at first-edit time — functionally
 * identical from the user's perspective, without ever storing a stale duplicate of a field the
...
import type { Company, CompanyOptionsSnapshot } from '@/types/Company';
