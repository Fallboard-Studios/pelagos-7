 ...
 * around the row", not just the slider itself), one shared `Lfo` display driven by whichever
 * field is currently targeted, and optional `driftContent` below it. Not schema-driven like
 * the 14 ControlSchema primitives — it composes caller-rendered sliders + one `Lfo`.
 */
