...
* **No collision-avoidance among spawn-time sibling companies** — confirmed out of scope in the intent doc; do not add a seeded-reroll mechanism for this.
